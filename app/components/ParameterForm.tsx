  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm border">
        <h3 className="text-lg font-semibold text-gray-900 mb-4">{t('mainModelConfig')}</h3>
        <MultiModelSelector
      ...
      {/* 辅助模型配置 */}
      <div className="bg-white p-6 rounded-lg shadow-sm border">
        <h3 className="text-lg font-semibold text-gray-900 mb-4">{t('auxiliaryModelConfig')}</h3>
        ...
        <div className="space-y-4">
          <div className="flex items-center space-x-4">
            ...
            />
            <label htmlFor="embedding" className="text-sm font-medium text-gray-700">
              {t('enableEmbedding')}
            </label>
            ...
            {params.embeddingModel.enabled && <span className="text-sm text-gray-500">GB</span>}
          </div>
          ...
          <div className="flex items-center space-x-4">
            ...
            {params.rerankModel.enabled && <span className="text-sm text-gray-500">{t('parameters')}</span>}
          </div>
          ...
          <div className="flex items-center space-x-4">
            ...
            {params.ocrModel.enabled && <span className="text-sm text-gray-500">GB</span>}
          </div>
      ...
      {/* 业务负载配置 */}
      <div className="bg-white p-6 rounded-lg shadow-sm border">
        <h3 className="text-lg font-semibold text-gray-900 mb-4">{t('businessLoadConfig')}</h3>
      ...
      {/* 系统配置 */}
      <div className="bg-white p-6 rounded-lg shadow-sm border">
        <h3 className="text-lg font-semibold text-gray-900 mb-4">{t('systemConfig')}</h3>
        ...
        <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
          <h4 className="text-sm font-semibold text-blue-900 mb-2">{t('calculationLogic')}</h4>
